...
public abstract class JmDNS implements Closeable {
  ...
  public static interface Delegate {
     ...
     *
     * @param dns   target DNS
     * @param infos service info registered with the DNS
     */
   ...
   * @param addr                  IP address to bind to.
   * @param name                  name of the newly created JmDNS
   * @param threadSleepDurationMs time in milliseconds that the JmDNS listener thread should sleep between multicast receives
   * @return jmDNS instance
   * @throws IOException if an exception occurs during the socket creation
   */
   ...
   * @param name    unqualified service name, such as <code>foobar</code> .
   * @param timeout timeout in milliseconds. Typical timeout should be 5s.
   * @return null if the service information cannot be obtained
   */
   ...
   * @param type       fully qualified service type, such as <code>_http._tcp.local.</code> .
   * @param name       unqualified service name, such as <code>foobar</code> .
   * @param persistent if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
   * @return null if the service information cannot be obtained
   */
   ...
   *
   * @param type    Service type name, such as <code>_http._tcp.local.</code>.
   * @param timeout timeout in milliseconds. Typical timeout should be 6s.
   * @return An array of service instance.
   */
   ...
   *
   * @param value new instance delegate
